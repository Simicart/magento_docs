...
`PUT /rest/giftvouchercheckouts/changeusecredit`


```shell
curl PUT "http://dev-magento19.jajahub.com/simiconnector/rest/v2/giftvouchercheckouts/changeusecredit" \
  -H "Authorization: Bearer <token>"
  -d "{
  "usecredit" : "1"
  }"
...
```json
{
      "gift_card": {
            ...
            "message": {
                "success": "Use Your Balance Credit !"
            }
       }
}
```
...
`PUT /rest/giftvouchercheckouts/changeusegiftcode`


```shell
curl PUT "http://dev-magento19.jajahub.com/simiconnector/rest/v2/giftvouchercheckouts/changeusegiftcode" \
  -H "Authorization: Bearer <token>"
  -d "{
  "giftvoucher" : "1"
  }"
...
```json
{
      "gift_card": {
            ...
            "credit": {
             ...
             "message": {
                 "success": "Use Your Gift Code !"
             }
       }
}
```

## Add Gift Code from Checkout
